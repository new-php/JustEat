...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="col-2 colo"><a class="extra mx-3" href=#>Inicia Sesión</a> <a class="extra mx-3" href="#">Ayuda</a></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col contenedor">
                ...
                <div class="row my-3 mx-3 rowbutton">
                    <input class="password" type="password" placeholder="Escribe tu contraseña">
                </div>

                <div class="row my-3 mx-3 rowbutton">
                    <input class="repassword" type="password" placeholder="Confirmar tu contraseña">
                </div>
