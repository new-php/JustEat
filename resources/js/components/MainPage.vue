            ...
            <div class="app-container">
                <div class="app-row">
                    <div class="logo-container">
                        <a href="/"><svg class="app-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 24">
                    ...
                    <div class="header-links">
                        <a class="help-link" href="help"><strong style="color: #FFF;">Ayuda</strong></a>
                        <a class="login-link" href="help">
                        ...
                        <a v-if="!username" class="login-link" href="login">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <a v-if="username" class="my-account-link" href="#">
        ...
        <div class="banner-section">
            ...
            <div class="address-section">
                <div class="address-container">
                    <h1 class="title1">Pide lo que te pida el cuerpo</h1>
        ...
        <div class="app-section">
            <div class="row justify-content-center contInfo">
                ...
                <div class="w-50 text-center m-auto">
                    <img src="storage/images/mobile-app.png" alt="">
                </div>

                <div class="w-50 text-center">
                    <span class="titleInfo1"><strong>Pide lo que te pida el cuerpo aún más rápido</strong></span>
                    <h5 class="title2 mt-4">Descárgate gratis la app y pide tu comida a domicilio estés donde estés. </h5>
                    <div class="row justify-content-center my-5">
                        <a class="mr-1" href="https://www.apple.com/app-store/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="135" height="40" viewBox="0 0 135 40">
                                <path fill="#A6A6A6" d="M130.197 40H4.73A4.739 4.739 0 0 1 0 35.267V4.727A4.734 4.734 0 0 1 4.73 0h125.467C132.803 0 135 2.12 135 4.726v30.54c0 2.606-2.197 4.734-4.803 4.734z"/>
                                <path d="M134.032 35.268a3.83 3.83 0 0 1-3.834 3.83H4.728a3.835 3.835 0 0 1-3.838-3.83V4.725A3.84 3.84 0 0 1 4.73.89h125.467c2.12 0 3.834 1.72 3.834 3.835l.01 30.543z"/>
                        ...
                        <a class="ml-1" href="https://play.google.com/store">
                            <svg id="artwork" xmlns="http://www.w3.org/2000/svg" width="135" height="40" viewBox="0 0 135 40">
                                ...
                                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="21.8" y1="173.29" x2="5.017" y2="156.508" gradientTransform="matrix(1 0 0 -1 0 182)">
                                ...
                                <path class="st2" d="M10.4 7.5c-.3.3-.4.8-.4 1.4V31c0 .6.2 1.1.5 1.4l.1.1L23 20.1v-.2L10.4 7.5z"/>
                                <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="33.834" y1="161.999" x2="9.637" y2="161.999" gradientTransform="matrix(1 0 0 -1 0 182)">
                                    <stop offset="0" stop-color="#FFE000"/>
                                    <stop offset=".409" stop-color="#FFBD00"/>
                                    <stop offset=".775" stop-color="#FFA500"/>
                                    <stop offset="1" stop-color="#FF9C00"/>
                                </linearGradient>
                                <path class="st3" d="M27 24.3l-4.1-4.1v-.3l4.1-4.1.1.1 4.9 2.8c1.4.8 1.4 2.1 0 2.9l-5 2.7z"/>
                                <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="24.827" y1="159.704" x2="2.069" y2="136.946" gradientTransform="matrix(1 0 0 -1 0 182)">
                                    <stop offset="0" stop-color="#FF3A44"/>
                                    <stop offset="1" stop-color="#C31162"/>
                                </linearGradient>
                                <path class="st4" d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4"/>
                                <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="7.297" y1="181.824" x2="17.46" y2="171.661" gradientTransform="matrix(1 0 0 -1 0 182)">
