<template>
    <div class="footer">
        ...
        <div class="country-section">
            ...
            <b-dropdown id="dropdown-dropup" dropup variant="custom" class="m-2">
                ...
                <b-dropdown-item class="country-item" href="#">
                    <div class="country-item-link">
                        ...
                        <span class="country-item-label">Australia</span>
                    </div>
                </b-dropdown-item>
                <b-dropdown-item class="country-item" href="#">
                    <div class="country-item-link">
            ...
            <div class="web-stamps">
                <img class="mastercard-icon" src="https://d2egcvq7li5bpq.cloudfront.net/sw/img/icons/cards/mastercard--securecode.svg">
                <img class="visa-icon" src="https://d2egcvq7li5bpq.cloudfront.net/sw/img/icons/cards/visa--verified.svg">
                <img class="safekey-icon" src="https://d2egcvq7li5bpq.cloudfront.net/sw/img/icons/cards/amex--safekey.svg">
                <img class="paypal-icon" src="https://d2egcvq7li5bpq.cloudfront.net/sw/img/icons/cards/paypal.svg">
                <img class="confianza-icon" src="https://d2egcvq7li5bpq.cloudfront.net/sw/img/icons/certificates/confianza.svg">
            </div>
        </div>
    </div>
